...
class EnciclopediaController extends Controller
{
    public function store(Request $request)
    {
        $request->validate([
            ...
            'ClasificacionISBN' => 'nullable|string|unique:enciclopedias,ClasificacionISBN',
    ...
    public function update(Request $request, $id)
    {
        $request->validate([
            ...
            'ClasificacionISBN' => 'nullable|string|unique:enciclopedias,ClasificacionISBN,' . $id . ',Recurso_ID',
            'Cantidad_Paginas' => 'nullable|integer|min:0',
        ], [
            'Titulo.unique' => 'Este título ya se encuentra registrado.',
            'ClasificacionISBN.unique' => 'Este ISBN ya pertenece a otra enciclopedia.'
        ]);
